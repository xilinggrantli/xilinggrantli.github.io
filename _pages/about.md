...
Broadly speaking, my research focuses on secure and private data management and its applications including verifiable query evaluation, oblivious outsourced querying and privacy-preserving machine learning. Meanwhile, I have extensive experience working with [secure multi-party computation](https://en.wikipedia.org/wiki/Secure_multi-party_computation), [zero knowledge proofs](https://en.wikipedia.org/wiki/Zero-knowledge_proof) and [differential privacy](https://en.wikipedia.org/wiki/Differential_privacy).
